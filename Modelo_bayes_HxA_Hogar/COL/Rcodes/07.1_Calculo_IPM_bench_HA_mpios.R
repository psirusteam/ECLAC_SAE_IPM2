...
saveRDS(contribuciones, "Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_mpio.rds")
saveRDS(ipm_HA, "Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_mpio.rds")


contribuciones <-readRDS("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_mpio.rds")
ipm_HA <- readRDS("Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_mpio.rds")


ipm_HA_agg <- ipm_HA %>% bind_rows() %>% group_by(dam2) %>%
  summarise_all(.funs = list("media" = mean, sd = sd))
mpios <- ipm_HA_agg$dam2
...
openxlsx::write.xlsx(list(ipm_HA = ipm_HA_agg,
                     ...
                     file ="Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_mpios.xlsx" 
                     )
openxlsx::openXL("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_mpios.xlsx")
