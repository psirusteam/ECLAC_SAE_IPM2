...
saveRDS(
  ...
  "Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_nacional.rds"
)
saveRDS(ipm_HA_nacional,
        "Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_calib_area_nacional.rds")

saveRDS(contribuciones_depto,
        "Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_dam.rds")
saveRDS(ipm_HA_depto,
        "Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_calib_area_dam.rds")

saveRDS(
  contribuciones_area,
  "Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_area.rds"
)
saveRDS(ipm_HA_area,
        "Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_calib_area_area.rds")

# Cargar objetos desde archivos .rds para el nivel nacional
contribuciones <-
  readRDS("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_nacional.rds")
ipm_HA <-
  readRDS("Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_calib_area_nacional.rds")
...
openxlsx::write.xlsx(list(ipm_HA = ipm_HA_agg,
                     ...
                     file = "Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_nacional.xlsx")
openxlsx::openXL("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_nacional.xlsx")

# Cargar objetos desde archivos .rds para el nivel departamental
contribuciones <-
  readRDS("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_dam.rds")
ipm_HA <-
  readRDS("Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_calib_area_dam.rds")
...
openxlsx::write.xlsx(list(ipm_HA = ipm_HA_agg,
                          contribuciones = contribuciones_agg),
                     file = "Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_dam.xlsx")
openxlsx::openXL("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_dam.xlsx")

# Cargar objetos desde archivos .rds para el nivel de área
contribuciones <-
  readRDS("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_area.rds")
ipm_HA <-
  readRDS("Modelo_bayes_HxA_Hogar/COL/Output/ipm_HA_calib_area_area.rds")
...
openxlsx::write.xlsx(list(ipm_HA = ipm_HA_agg,
                          contribuciones = contribuciones_agg),
                     file = "Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_area.xlsx")
openxlsx::openXL("Modelo_bayes_HxA_Hogar/COL/Output/contribuciones_calib_area_area.xlsx")
