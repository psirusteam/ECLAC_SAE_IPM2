...
library(furrr)
library(openxlsx)
source("Modelo_bayes_HxA_Hogar_freq/0funciones/Estimar_ipm.R")
source("Modelo_bayes_HxA_Hogar_freq/0funciones/agregado_dim_ipm.r")
################################################################################
# Lectura de base de datos
################################################################################
censo_ipm <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Censo/censo_COL_recor.rds") 

################################################################################
## Lectura de variables dummy  
################################################################################

epred_mat_dummy_hnolee <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hnolee_ee.rds")
epred_mat_dummy_hlogroeduc <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hlogroeduc_ee.rds")
epred_mat_dummy_heducninios <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_heducninios.rds")
epred_mat_dummy_hhacina <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hhacina.rds")
epred_mat_dummy_henergia <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_henergia.rds")
epred_mat_dummy_htic <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_htic.rds")
epred_mat_dummy_hagua <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hagua_ee.rds")
epred_mat_dummy_hsaneamiento <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hsaneamiento_ee.rds")
epred_mat_dummy_hsalud <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hsalud_ee.rds")
epred_mat_dummy_hpartemp <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hpartemp.rds")
epred_mat_dummy_hempe <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hempe.rds")
epred_mat_dummy_hjub <- readRDS("Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/epred_mat_dummy_nbi_hjub.rds")
...
estimacion_dam2 <-
 ...
 saveRDS(estimado_ipm, file = "Modelo_bayes_HxA_Hogar_freq/COL/Data/Modelo/estimado_ipm_HA_freq.rds")
 ...
 saveWorkbook(wb, file = "Modelo_bayes_HxA_Hogar_freq/COL/Output/estimacion_ipm.xlsx",
              overwrite = TRUE)
 openxlsx::openXL("Modelo_bayes_HxA_Hogar_freq/COL/Output/estimacion_ipm_freq.xlsx")
 openxlsx::openXL("Modelo_bayes_HxA_Hogar_freq//COL/Output/estimacion_ipm.xlsx") 
...
saveRDS(temp_estimate_mpio, "Modelo_bayes_HxA_Hogar_freq/COL/data/Modelo/temp_estimate_mpio.rds")
